...
:class:`streak_finder.ComposeTransforms`. You pass a :class:`streak_finder.Transform` instance to a data
container :class:`streak_finder.CrystData`. All transform classes are inherited from the abstract
:class:`streak_finder.Transform` class.
"""
